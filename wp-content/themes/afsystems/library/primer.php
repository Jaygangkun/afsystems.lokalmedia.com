...
function primer_scripts_and_styles() {
  if (!is_admin()) {
    ...
    // fancybox stylesheet
    wp_register_style( 'fancybox-stylesheet', get_stylesheet_directory_uri() . '/library/css/libs/jquery.fancybox.min.css', array(), '', 'all' );
    
    // animate on scrroll stylesheet
    wp_register_style( 'aos-stylesheet', get_stylesheet_directory_uri() . '/library/css/libs/aos.css', array(), '', 'all' );
